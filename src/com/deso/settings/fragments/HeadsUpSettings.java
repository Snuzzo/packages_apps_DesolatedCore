...
public class HeadsUpSettings extends DesoSettingsFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        title = getResources().getString(R.string.headsup_enabled);
